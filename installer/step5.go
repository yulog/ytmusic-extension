...
func (s *Step5) SetModel(model *Model) {
	s.model = model
}

func (s *Step5) AppendChildWidgets(context *guigui.Context, appender *guigui.ChildWidgetAppender) {
	appender.AppendChildWidget(&s.bodyText)
}

func (s *Step5) Build(context *guigui.Context) error {
